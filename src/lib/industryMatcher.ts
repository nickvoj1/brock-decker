...
export const TITLE_TO_INDUSTRY: Record<string, { industries: string[]; requiresContext?: boolean }> = {
  ...
  "it consultant": { industries: ["IT Services & Consulting", "Management Consulting"] },
  "it consulting": { industries: ["IT Services & Consulting"] },
  "technology consultant": { industries: ["IT Services & Consulting"] },
  "tech consultant": { industries: ["IT Services & Consulting"] },
  "solutions architect": { industries: ["IT Services & Consulting", "Cloud Services"] },
  "solution architect": { industries: ["IT Services & Consulting", "Cloud Services"] },
  "enterprise architect": { industries: ["IT Services & Consulting"] },
  "cloud engineer": { industries: ["Cloud Services", "IT Services & Consulting"] },
  "cloud architect": { industries: ["Cloud Services", "IT Services & Consulting"] },
  "devops": { industries: ["IT Services & Consulting", "Computer Software"] },
  "site reliability": { industries: ["IT Services & Consulting", "Computer Software"] },
  "sre": { industries: ["IT Services & Consulting", "Computer Software"] },
  "software engineer": { industries: ["Computer Software", "SaaS"] },
  "software developer": { industries: ["Computer Software", "SaaS"] },
  "full stack": { industries: ["Computer Software", "SaaS"] },
  "frontend": { industries: ["Computer Software", "SaaS"] },
  "backend": { industries: ["Computer Software", "SaaS"] },
  "data engineer": { industries: ["Data & Analytics", "Computer Software"] },
  "data scientist": { industries: ["Data & Analytics", "AI & Machine Learning"] },
  "machine learning engineer": { industries: ["AI & Machine Learning", "Computer Software"] },
  "ml engineer": { industries: ["AI & Machine Learning", "Computer Software"] },
  "cybersecurity": { industries: ["Cybersecurity", "Computer & Network Security"] },
  "security engineer": { industries: ["Cybersecurity", "Computer & Network Security"] },
  "infosec": { industries: ["Cybersecurity", "Computer & Network Security"] },
  "ciso": { industries: ["Cybersecurity", "IT Services & Consulting"] },
  "cto": { industries: ["IT Services & Consulting", "Computer Software"], requiresContext: true },
  "cio": { industries: ["IT Services & Consulting"], requiresContext: true },
  "systems integrator": { industries: ["Systems Integration", "IT Services & Consulting"] },
  "digital transformation": { industries: ["IT Services & Consulting", "Management Consulting"] },
  "salesforce consultant": { industries: ["IT Services & Consulting", "SaaS"] },
  "sap consultant": { industries: ["IT Services & Consulting"] },
  "oracle consultant": { industries: ["IT Services & Consulting"] },
  "erp consultant": { industries: ["IT Services & Consulting"] },
};
